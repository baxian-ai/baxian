...
export function Terminal() {
  ...
  if (!agentId) return <div className="text-[14px] text-danger">No agent specified</div>;
  ...
  return (
    <div data-testid="terminal-page-container" className="flex min-h-0 flex-1 flex-col overflow-hidden border border-hairline bg-surface">
      <div className="flex h-8 flex-none select-none items-center gap-3 border-b border-hairline bg-page px-3 font-mono text-[12px] text-og-500">
